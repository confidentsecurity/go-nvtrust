...
typedef struct { struct nscq_session_st* handle; } nscq_session_t;
typedef struct { struct nscq_observer_st* handle; } nscq_observer_t;
typedef struct { struct nscq_writer_st* handle; } nscq_writer_t;
